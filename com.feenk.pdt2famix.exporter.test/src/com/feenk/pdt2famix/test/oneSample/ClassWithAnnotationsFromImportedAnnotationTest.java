...
public class ClassWithAnnotationsFromImportedAnnotationTest extends OneSampleTestCase {
	
	protected String sample() {
		return removeTestSuffix(ClassWithAnnotationsFromImportedAnnotationTest.class.getSimpleName());
	}
	
	protected String annotationTagName() {
		return "Annotation_ForClassWithAnnotationsFromImportedAnnotation";
	}
	...
	public void testAnnotationTypesPresent() {
		...
		assertAnnotationTypePresent(typeIdentifier(
				"annotations_namespace_ForClassWithAnnotationsFromImportedAnnotation",
				"Id_ForClassWithAnnotationsFromImportedAnnotation"));
	}
	
	@Test
	public void testAnnotationTypes() {
		AnnotationType annotationTagType = annotationTypeNamed(annotationTagTypeName()); 
		AnnotationType annotationId = annotationTypeNamed("Id_ForClassWithAnnotationsFromImportedAnnotation");
